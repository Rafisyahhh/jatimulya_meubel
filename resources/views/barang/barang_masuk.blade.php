@extends('layouts.app')
@section('judul', 'Barang Masuk | Jatimulya Mebel')
@section('content')
    ...
    <div class="page-heading">
        <h3 style="color: #960404">Barang Masuk</h3>
    </div>
    <div class="page-content">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Data Barang Masuk
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Tambah Barang Masuk</h4>
                ...
                <form action="{{ route('barang_masuk.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="alamat">Stok Masuk: </label>
                        <div class="form-group">
                            <input id="alamat" name="stok_masuk" value="{{ old('stok_masuk') }}" type="text"
                                placeholder="Masukkan Stok Masuk" class="form-control">
                        </div>
                        <label for="deskripsi">Tanggal Masuk: </label>
                        <div class="form-group">
                            <input id="alamat" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" type="date"
                                placeholder="Masukkan Tanggal Masuk" class="form-control">
                        </div>
                    </div>
    ...
    @foreach ($barang_masuk as $item)
        <div class="modal fade text-left" id="modalEdit{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Ubah Barang Masuk</h4>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
                    <form action="{{ route('barang_masuk.update', $item->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <label for="alamat">Stok Masuk: </label>
                            <div class="form-group">
                                <input id="alamat" name="stok_masuk" value="{{ $item->stok_masuk }}" type="text"
                                    placeholder="Masukkan Status Penduduk" class="form-control">
                            </div>
                            <label for="deskripsi">Tanggal Masuk: </label>
                            <div class="form-group">
                                <input id="alamat" name="tanggal_masuk" value="{{ $item->tanggal_masuk }}"
