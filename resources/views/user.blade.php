@extends('layouts.app')
@section('judul', 'User | Jatimulya Mebel')
@section('content')
                    ...
                    <tbody>
                        ...
                        @foreach ($user as $item)
                            @if (auth()->id() !== $item->id)
                                ...
                                @php
                                    $counter++; // Menambahkan variabel counter
                                @endphp
                            @endif
                        @endforeach
                    </tbody>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('user.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input id="alamat" name="email" value="{{ old('email') }}" type="email"
                                placeholder="Masukkan Email" class="form-control">
                        </div>
                        <label for="deskripsi">Password: </label>
                        <div class="form-group">
                            <input id="alamat" name="password" type="password" placeholder="Masukkan Password"
                                class="form-control">
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('user.update', $item->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            <label for="alamat">Nama: </label>
                            <div class="form-group">
                                <input id="alamat" name="name" type="text" placeholder="Masukkan Nama anda"
                                    value="{{ $item->name }}" class="form-control">
                            </div>
                            <label for="deskripsi">Email: </label>
                            <div class="form-group">
                                <input id="alamat" name="email" type="email" placeholder="Masukkan Email anda"
